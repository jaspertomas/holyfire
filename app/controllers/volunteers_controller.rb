  ...
  def create
    ...
    respond_to do |format|
      if @volunteer.save
        ...
        if params[:commit]==["Create volunteer and add another"]
          format.html { redirect_to action:"new", controller:"volunteers", notice: 'Volunteer "+@volunteer.name+" was successfully created.' }
