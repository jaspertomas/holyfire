...
class Participant < ActiveRecord::Base
  ...
  attr_accessible :address, :age, :batch_id, :blessing_id, :donation, :guarantor, :introducer, :missionary, :fname, :mname, :lname, :occupation, :remark, :sex, :tel, :is_finalized, :created_by_id, :updated_by_id, :no, :batched_by_id
  belongs_to :blessing
  belongs_to :batch
  belongs_to :created_by, :class_name => "User", :foreign_key => 'created_by_id'
  belongs_to :updated_by, :class_name => "User", :foreign_key => 'updated_by_id'
  belongs_to :batched_by, :class_name => "User", :foreign_key => 'batched_by_id'
